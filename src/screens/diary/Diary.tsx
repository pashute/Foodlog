...
// sheet. All non-React logic lives in diaryEntry.ts — this file is
// presentational only.
...
// (diaryEntry.ts) instead of the AI's status field; meal textbox locks
...
export default function Diary() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(e.message === 'Not implemented yet' ? e.message : diaryError(e))
      setRecords([])
    }
  }
