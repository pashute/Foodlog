...
// can't load a .tsx file at all (not even a parse issue, Node's loader
// rejects the extension outright), so oauth.mock.ts and feature step defs
...
// Called by the .dlg.tsx component to register how it toggles its own
// `visible` state.
