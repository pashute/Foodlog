// Filename: oauth.mock.js  Version 0.2.0

// Mock OAuth module (prototype stage). Orchestrates the two popup
// components (accountChoice.mock.dlg.jsx, permitConsent.mock.dlg.jsx)
...
// `node --test` can't parse that, same reason auth.js lazy-loads its
...
export async function login() {
  const { popup: accountChoicePopup } = await import('./accountChoice.mock.js')
  ...
  const { popup: permitConsentPopup } = await import('./permitConsent.mock.js')
