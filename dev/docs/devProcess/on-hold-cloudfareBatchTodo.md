...
- [v] src/backend/configuration/config.servercode.ts — KV config storage (theme, timezone). Routes: /theme, /timezoneOffset, /timezoneAbbrev, /timezoneLocation with Bearer token auth validation.
