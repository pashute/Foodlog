...
- Features should be uncoupled from implementation technology details. the steps should call modules that work and know nothing of the development stage or platform. the forking should happen in the actual source code of the module, not in the test's code. 
