...
Given('the app header is open', function () {
...
Then('the header is a stripe at the top of the app screen', function () {
  throw new Error('Not implemented yet')
})

Then('the app name is to the left with a larger font', function () {
  throw new Error('Not implemented yet')
})

Then('the version is in the format vX.Y.Z with a smaller font', function () {
  throw new Error('Not implemented yet')
})

Then('there is a Login with Google button aligned to the right', function () {
  throw new Error('Not implemented yet')
})

Then('the hamburger icon is aligned in the far right corner', function () {
  throw new Error('Not implemented yet')
})
